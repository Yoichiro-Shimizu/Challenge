...
<body>
    ...
    <?php
    for($i = 1; $i<=3; $i++){ ?>
    <input type="radio" name="id" value="<?php echo $i; ?>"<?php if($i==$result[0]['type']){echo "checked";}?>><?php echo ex_typenum($i);?><br>
    <?php } ?>
    <br>
